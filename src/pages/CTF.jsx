...
import { Terminal, Shield, Lock, Award, CheckCircle } from 'lucide-react';

const SPEC_LIST = [
  { icon: Shield, label: 'FORMAT TYPE', value: 'Jeopardy-Style CTF' },
  { icon: Lock, label: 'SYSTEM TRACKS', value: 'Pwn, Crypto, Web, Forensics' },
  { icon: Award, label: 'CHAMP PRIZE', value: '50K BDT cash' },
];

const GUIDELINES = [
  "Squad size rules: 1 to 3 cybersecurity players from the same institution.",
  "Jeopardy flag submission metrics award scores dynamically based on category level indexes.",
  "Brute forcing platform components or attacking opponent console systems is strictly prohibited.",
  "Flag strings carry uniform formatting matching BUPCTF{regex_code} syntax.",
  "Realtime dynamic scoreboards update automatically during active CTF competitive windows."
];

export default function CTF({ setActivePage }) {
  return (
    <PageWrapper>
      ...
      <div className="max-w-4xl mx-auto px-6 space-y-12 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm font-mono text-primary/70 dark:text-white/60 leading-relaxed max-w-xl">
            Audit configurations, breach sandboxed environments, track cryptography anomalies, and extract secure flags in a competitive environment.
          </p>
        </div>
